                ...
                >
                  <ul>
                    ...
                    >
                      ...
                      <!-- LAYER NR. 3 -->
                      <div
                        class="tp-caption button red tp-resizeme"
                        id="slide-5-layer-10"
                        data-x="center"
                        data-hoffset=""
                        data-y="bottom"
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="section-title">
                      <h2>MENGAPA HARUS MEMBELI HYUNDAI DI DEALER KAMI?</h2>
                ...
                <div class="row">
                  <div class="col-lg-4 col-md-7">
                    <div class="feature-box text-center">
                      ...
                      <div class="content">
                        <h6>Dealer Resmi Hyundai</h6>
                        <p>
                          Dealer Resmi Hyundai Terpercaya dan sudah Puluhan Tahun Melayani Penjualan Unit Hyundai ke Seluruh Indonesia
                        </p>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-4 col-md-7">
                    <div class="feature-box text-center">
                      ...
                      <div class="content">
                        ...
                        <p>
                          Pelayanan kami 24 jam untuk anda, Seputar Konsultasi pembelian Mobil Baru, Dan Problem Kendaraan anda.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-4 col-md-7">
                    <div class="feature-box text-center">
                      ...
                      <div class="content">
                        <h6>Harga Termurah</h6>
                        <p>
                          Kami Selalu Memberikan Harga Dan Penawaran Promo Termurah Dengan Kemudahan Transaksi.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <section class="feature-car bg-2 bg-overlay-black-70 page-section-ptb">
              <div class="container">
                <div class="row">
                  <div class="col-md-12">
                    <div class="section-title">
                      <h2 class="text-white">PILIHAN MOBIL HYUNDAI</h2>
                      <div class="separator"></div>
                    </div>
                  </div>
                </div>
            ...
            <div class="row g-0">
              ...
              <div class="col-lg-6 col-md-12 gray-bg text-center">
                <div class="custom-block-1">
                  <h2>PROMO</h2>
                  <p>PESAN HYUNDAI STARGAZER SEKARANG!</p>
                  <p>Info Pemesanan</p>
                  <strong class="text-red">Rp243.300.000</strong>
                  <span>HP : 0812 9011 9075 (WA)</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="container">
                <div class="row justify-content-center">
                  <div class="col-lg-8 col-md-12 text-center">
                    <h3 class="text-white">
                      Ingin tahu lebih banyak tentang kami? Putar video promosi kami sekarang!
                    </h3>
                  </div>
                </div>
              </div>
              ...
              <div class="row justify-content-center">
                <div class="col-lg-10 col-md-12">
                  <div class="video-info text-center">
                    ...
                    <a
                      class="popup-youtube"
                      href="https://www.youtube.com/watch?v=tILufiMDM9c"
                    >
...
export default {
    components: { Header, Footer, Feature, Call },
    name: "Index",
}
console.log(history)
</script>
